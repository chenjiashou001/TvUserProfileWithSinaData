...
public class PrintClass {   
	//static Logger logger = Logger.getLogger(PrintClass.class);
...
//    }
    ...
    public static String outObjPropertyString(Object obj) 
    {
        ...
        if(null != obj)
        {
            try {
            	...
            	LogUtil.error("outObjPropertyString is error " + e.getMessage());
                e.printStackTrace();
            }
        }
        return sb.toString();
    ...
    private static Object invokeMethod(Object owner, String methodName, Class fieldType, Object[] args) throws Exception{
